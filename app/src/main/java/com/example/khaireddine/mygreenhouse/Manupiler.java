...
public class Manupiler extends AppCompatActivity {
    ...
    String[] SPINNERLIST = {"Serre 1", "Serre 2", "Serre 3", "Serre 4","Serre 5"};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_manupiler);
...
Spinner spinner_serre = (Spinner) findViewById(R.id.serre_spinner);
       spinner_serre.setAdapter(arrayAdapter);
        arrayAdapter.setDropDownViewResource(R.layout.spinner_items);
        // Apply the adapter to the spinner_items
        if (spinner_serre != null) {
            spinner_serre.setAdapter(arrayAdapter);
        }
    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            /*
            View rootView = inflater.inflate(R.layout.fragment_humidite, container, false);
